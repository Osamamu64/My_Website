...
app.route('/PrintTicket').get(function(req, res) {
  res.send("<h1 style='text-align:center; text-decoration:underline;'>Ticket Details</h1>" +
           "<p style='text-align:center'><b>Full Name: </b>" + str.Full_Name + "<br><b>Phone#: </b>" + str.Phone +
           "<br><b>Email: </b>" + str.Email + "<br><b>Departure: </b>" + str.Departure + "<br><b>Destination: </b>" +
           str.Destination + "<br><b>Date: </b>" + str.Date + "<br><b>Time: </b>" + str.Time + "<br><b>Seat Type: </b>" +
           str.Seat_Type + "</p>" + "<p align='center'><input type='button' value='PRINT'onclick='window.print(); return true;'></p>");
});
